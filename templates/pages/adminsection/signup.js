...
function Register() {
    ...
    const onSubmit =  (e) => {
        ...
        var session_url = 'http://localhost:8000/adminApi/adminSignup';
                                ...
                                <div className="login_wrap widget-taber-content p-30 bg-white border-radius-10">
                                    <div className="padding_eight_all bg-white">
                                        <div className="heading_s1 text-center">
                                            <h3 className="mb-30 font-weight-900"> Admin Sign Up </h3>
                                        </div>
                                        ...
                                        <div className="text-muted text-center">Already have an Admin account? <Link href="signin">
                                            <a>Log In  Now</a>
                                        </Link></div>
                                    </div>
                                </div>
