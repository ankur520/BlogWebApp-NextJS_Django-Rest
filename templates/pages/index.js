...
import BottomCarousel from "../components/slider/BottomCarousel";
...
{allblogs.map( (blogitem) => {
                                ...
                                <article key={blogitem.id}
                                className="col-lg-4 col-md-6 mb-30 wow fadeInUp animated"
                                data-wow-delay="0.4s"
                            >

                                <div className="post-card-1 border-radius-10 hover-up" key={blogitem.id}>
                                    <div
                                        className="post-thumb thumb-overlay img-hover-slide position-relative"
                                        style={{
                                            backgroundImage:
                                    ...
                                    <div className="post-content p-30">
                                        <div className="entry-meta meta-0 font-small mb-10">
                                            ...
                                            <Link href={`/category/${blogitem.category}/`}>
                                                <a>
