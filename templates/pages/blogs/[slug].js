...
function Single(props) {
  ...
  const [blogdetail, setblogdetail] = useState(props.allBlog);
            ...
            <div className="container entry-header-content">
              ...
              <div className="entry-meta align-items-center meta-2 font-small color-white">
                <p className="mb-5 text-white">
                  ...
                  By{" "}
                  <Link  href= {`/author/${articleCreatedBy}/`}  >
                    <a>
          ...
          <div className="container single-content">
            ...
            <article className="entry-wraper mb-50">
              ...
              <div className="entry-main-content dropcap wow fadeIn animated">
                ...
                <p>
                  Thnks sniffed in hello after in foolhardy and some far
...
export async function getStaticPaths() {
  var session_url = "http://localhost:8000/blogApi/getBlog";
  ...
  const paths = allBlogss.map((fetchdata) => {
    return {
      params: { slug: fetchdata.slug.toString() },
    };
  });
...
export async function getStaticProps(context) {
  ...
  var session_url = `http://localhost:8000/blogApi/getBlogwith/${slug}/`;
  ...
  await axios
    ...
    .then(function (response) {
      // console.log("GET request inside function response &&&&&&&&&& ");
      allBlog = response.data.blogswithslug;
      // console.log(allBlog);
